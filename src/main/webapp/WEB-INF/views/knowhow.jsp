...
for(var i=1 ; i <=pageCnt; i++){
  htmlStr += '<li><a style="font-size:1.5rem; color: black; text-decoration: none;" href="knowhow.do?startPage='+i+'">'+i+'</a></li>'
};
      ...
      <div class="row">
        <div class="mt_content">
              ...
              <col style="width:10%">
                  ...
                  <tbody>
                    <c:forEach var="knowhow" varStatus="status" items="${KnowhowList}">
                          <tr>
                             <td>${status.count}</td>
                             <td>${knowhow.kpUser}</td>
                             <td>${knowhow.kpTitle}</td>
                             <td>${knowhow.kpDate}</td>
                             <td>${knowhow.kpView}</td>
                          </tr>
                        </c:forEach>
                   </tbody>
          </table>
